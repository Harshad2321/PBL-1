...
from nurture.core.data_structures import (
    ...
    EmotionalImpact, RelationshipState, AIPersonalityState
)
...
from nurture.core.relationship_dynamics import (
    analyse_message, update_dynamics, get_relationship_prompt_context
)
    ...
    def process_input(self, message: str, context: Optional[DialogueContext] = None) -> None:
        ...
        self._event_bus.publish(Event(
            ...
            data={
                ...
                "relationship_deltas": self._last_deltas,
            }
        ))
